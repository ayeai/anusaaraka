...
(id-root ?id age)
?mng <-(meaning_to_be_decided ?id)
(id-word =(+ ?id 1) technology)
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id yuga))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  age.clp 	age1   "  ?id "  yuga )" crlf))
)
...
(assert (id-wsd_word_mng ?id vqxXa))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_word_mng  " ?*wsd_dir* "  age.clp  	age4   "  ?id "  vqxXa )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  age.clp 	age5   "  ?id "  umra )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  age.clp 	age6   "  ?id "  vayaska_ho )" crlf))
)
