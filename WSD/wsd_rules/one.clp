...
(printout wsd_fp "(dir_name-file_name-rule_name-root_id-TAM-vachan   " ?*wsd_dir* "  one.clp       one1   "  ?id " s )"crlf))
)
...
(printout wsd_fp "(dir_name-file_name-rule_name-root_id-TAM-vachan   " ?*wsd_dir* "  one.clp       one2   "  ?id "  s )" crlf))
)
...
(printout wsd_fp "(dir_name-file_name-rule_name-root_id-TAM-vachan   " ?*wsd_dir* "  one.clp    one22   "  ?id " s )" crlf))
)
