...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  beat.clp 	beat4   "  ?id "  Xadakana )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  beat.clp 	beat5   "  ?id "  Xadaka )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  beat.clp 	beat6   "  ?id "  takarA )" crlf))
)

;The rules beat3, beat4,beat5 and beat6 were modified by Meena on 20.12.08.
