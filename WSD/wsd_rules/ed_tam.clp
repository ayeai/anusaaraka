...
;Commented by Meena(24.9.09) as ed_tam2 and ed_tam3 are same  
(defrule ed_tam3
...
(assert (id-E_tam-H_tam_mng ?id ed yA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-H_tam_mng  " ?*wsd_dir* "  ed_tam.clp  	ed_tam3  "  ?id "  yA )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-H_tam_mng  " ?*wsd_dir* "  ed_tam.clp        ed_tam5  "  ?id "  WA )" crlf))
)
