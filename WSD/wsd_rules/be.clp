...
(assert (id-wsd_word_mng ?id hE))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_word_mng  " ?*wsd_dir* "  be.clp  	be2   "  ?id "  hE )" crlf))
)
...
(assert (id-wsd_word_mng ?id hE))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_word_mng  " ?*wsd_dir* "  be.clp  	be5   "  ?id "  hE )" crlf))
)
