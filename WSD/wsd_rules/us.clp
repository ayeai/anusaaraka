...
(printout wsd_fp "(dir_name-file_name-rule_name-root_id-TAM-vachan   " ?*wsd_dir* "  us.clp        us1   "  ?id " p )" crlf))
)
...
(printout wsd_fp "(dir_name-file_name-rule_name-root_id-TAM-vachan   " ?*wsd_dir* "  us.clp        us2   "  ?id " p )" crlf))
)
