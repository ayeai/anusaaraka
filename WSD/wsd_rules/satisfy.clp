...
=>
(retract ?mng)
(assert (id-wsd_word_mng ?id saMwuRta_kara))
(assert (id-H_vib_mng ?id yA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_word_mng  " ?*wsd_dir* "  satisfy.clp  	satisfy0   "  ?id "  saMwuRta_kara )" crlf)
