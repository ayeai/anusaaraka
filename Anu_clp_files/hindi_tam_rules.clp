...
;(root-verbchunk-tam-chunkids  ?root  ?orig-tam  could_be_en  $?ids ?head_id)
;=>
;(printout  ?*Hin_tam_fp*  "(tam_tmp_info  (head_id  "?head_id")  (eng_tam could_be_en) (hin_tam yA_jA_sakA)  )" crlf)
;)
...
;(defrule tam99
;(root-verbchunk-tam-chunkids  ?root  ?orig-tam for_ing  $?ids ?head_id)
;=>
;(printout  ?*Hin_tam_fp*  "(tam_tmp_info  (head_id  "?head_id")  (eng_tam for_ing) (hin_tam ne_ke_liye))" crlf)
;)
...
=>
(printout  ?*Hin_tam_fp*  "(tam_tmp_info  (head_id  "?head_id")  (eng_tam shall_0) (hin_tam _gA))" crlf)
)
...
;I want to go
(defrule tam309
(root-verbchunk-tam-chunkids ?root ?orig-tam  want_to_0 $?ids ?head_id)
=>
(printout  ?*Hin_tam_fp* "(tam_tmp_info  (head_id  "?head_id") (eng_tam  want_to_0) (hin_tam nA_cAhawA_hE))" crlf)
)
...
(defrule tam311
(root-verbchunk-tam-chunkids ?root ?orig-tam  can_not_afford_to_0 $?ids ?head_id)
=>
(printout  ?*Hin_tam_fp* "(tam_tmp_info  (head_id  "?head_id") (eng_tam  can_not_afford_to_0)(preceding_part_of_the_verb  nahIM)(hin_tam ne_kI_sWiwi_meM_ho))" crlf)
)

;They decided not to take legal action against him .
(defrule tam312
(root-verbchunk-tam-chunkids ?root ?orig-tam  decided_not_to_0 $?ids ?head_id)
=>
(printout  ?*Hin_tam_fp* "(tam_tmp_info  (head_id  "?head_id") (eng_tam  decided_not_to_0)(preceding_part_of_the_verb  nahIM)(hin_tam ne_kA_niScaya_kiyA))" crlf)
)

;The professor decided to write a book .
(defrule tam313
(root-verbchunk-tam-chunkids ?root ?orig-tam  decided_to_0 $?ids ?head_id)
=>
(printout  ?*Hin_tam_fp* "(tam_tmp_info  (head_id  "?head_id") (eng_tam  decided_to_0)(hin_tam ne_kA_niScaya_kiyA))" crlf)
)

;However the user needs some training to use the software effectively .
(defrule tam314
(root-verbchunk-tam-chunkids  ?root  ?orig-tam needs_to_0  $?ids ?head_id)
=>
(printout  ?*Hin_tam_fp*  "(tam_tmp_info  (head_id  "?head_id")  (eng_tam needs_to_0) (subject_vibhakti ko) (hin_tam nA_kI_jZarUrawa_hE))" crlf)
)
...
(defrule tam317
(root-verbchunk-tam-chunkids  ?root  ?orig-tam be_allowed_to_0  $?ids ?head_id)
=>
(printout  ?*Hin_tam_fp*  "(tam_tmp_info  (head_id  "?head_id")  (eng_tam be_allowed_to_0) (hin_tam ne_xiyA_jAye)(subject_vibhakti ko))" crlf)
)
