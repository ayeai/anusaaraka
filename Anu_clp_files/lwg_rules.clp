...
;(parserid-wordid   ?y  ?x)
;=>
; (printout  old_lwg_file  "(lwg_root-verbchunk-tam-chunkids   "  ?rt   "  for_"?word "  for_ing   " ?ID0 "  " ?ID1 ")" crlf )
; (retract ?f0 ?f1 ))
;नेकेलिये
(defrule rule97
(declare (salience 20))
...
;(parserid-wordid   ?y  ?x)
;=>
; (printout  old_lwg_file  "(lwg_root-verbchunk-tam-chunkids   "  ?rt   "  to_"?word "  to_0   " ?ID0 "  " ?ID1 ")" crlf )
; (retract ?f0 ?f1 ))
;नेकेलिये
(defrule rule237
(declare (salience 30))
