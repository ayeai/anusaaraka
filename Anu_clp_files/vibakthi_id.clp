 (defglobal ?*vib_id_file* = vib_id_fp)
...
=>
 ...
 =>
        ...
        (printout ?*vib_id_file* "(id-TAM " ?root_id " ed_en)" crlf)
 )
 ...
 =>
        ...
        (printout ?*vib_id_file* "(id-TAM " ?root_id "  " ?tam ")" crlf)
 )
...
; The boy saw an elephant in the forest .
 ...
 =>
	...
	(printout ?*tam_id_file* "(id-TAM " ?root_id " ed)" crlf)
        (printout ?*vib_id_file* "(id-TAM " ?root_id " ed)" crlf)
 )
 ...
 =>
        ...
        (printout ?*vib_id_file* "(id-TAM " ?id " ed_en )" crlf)
  )
 ...
 =>
        ...
        (printout ?*vib_id_file* "(id-tam " ?id " 0)" crlf)
 )
 ...
 =>
	...
	(printout ?*vib_id_file* "(id-tam " ?id " ing)" crlf)
 )
 ...
 =>
	...
	(printout ?*vib_id_file* "(id-tam " ?id " en)" crlf)
 )
 ...
 =>
	...
	(printout ?*vib_id_file* "(id-tam " ?id " ed)" crlf)
 )
