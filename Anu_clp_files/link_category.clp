...
; Removes the first characterfrom the input symbol which is assumed to contain digits only from the second position onward; length should be less than 10000]
 ...
 (or (link_name-link_expansion  ?P  P g ? b $?)(link_name-link_expansion  ?P  P v)(link_name-link_expansion  ?P  P v f)(link_name-link_expansion  ?P  P P)(link_name-link_expansion  ?P  P g))
 (link_name-link_lnode-link_rnode ?sub  ?sl_node  ?sr_node)
 (link_name-link_lnode-link_rnode ?P   ?sr_node  ?Pr_node)
 (linkid-word ?sr_node ?sword)
 (linkid-word ?Pr_node ?pword)
 ...
 (link_name-link_expansion ?sub S $?ids)
 (link_name-link_lnode-link_rnode ?sub  ?sl_node  ?sr_node)
 (linkid-word ?sr_node ?rword&~that)
 ?f0<-(category_to_be_decided ?sr_node)
 (test (not (member$ I $?ids)) )
 =>
	(retract ?f0) 
  ...
  (link_name-link_expansion ?sub S $?ids)
  (link_name-link_lnode-link_rnode ?sub  ?sl_node  ?sr_node)
  (linkid-word ?sl_node ?lword&~that)
  ?f0<-(category_to_be_decided ?sl_node)
  (test (member$ I $?ids) )
  =>
        (retract ?f0)
  ...
  (linkid-word ?dl_node ?dlword)
  (linkid-word ?dr_node ?drword)
  ...
  (linkid-word ?lid ?lword&he|she|they|this|we|all|I|it|you|me)
  =>
               (retract ?f0)
  ...
  (linkid-word ?lid ?lword&he|she|they|this|we|all|I|it|you)
