 ...
 export JAVA_HOME=/home/anu/jdk1.6.0_03/
 export PATH=/home/anu/jdk1.6.0_03/bin/:$PATH
 ...
 if  [ -e $MYPATH/tmp/$1_tmp/sent ] ; then
    rm -rf $MYPATH/tmp/$1_tmp/sent
 fi

 mkdir $MYPATH/tmp/$1_tmp/sent
...
./link-parser $HOME_anu_test/LINK/link-grammar-4.5.7/data/en $MYPATH/tmp $1 $2 < $MYPATH/tmp/$1_tmp/one_sentence_per_line.txt
 ...
 sh $HOME_anu_test/shell_scripts/ClipsToAnu_browser_intfc-sent.sh $1 $MYPATH
 ...
 cp -r sent sent-by-sent $1.xml $1.html $1_trnsltn.html $1.txt.html $MYPATH/tmp/.
 ...
 cp -r $MYPATH/tmp/sent/* $MYPATH/tmp/sent-by-sent $MYPATH/tmp/$1.xml $MYPATH/tmp/$1.html $MYPATH/tmp/$1_trnsltn.html $MYPATH/tmp/$1.txt.html $MYPATH/tmp/$1_tmp/.
