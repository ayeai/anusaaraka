 ...
 myclips -f $HOME_anu_test/Anu_clp_files/run_modules.bat >  $1.error
...
cd $MYPATH/$1_tmp/$2
 ...
 cat  original_word.dat word.dat punctuation.dat chunk.dat cat_consistency_check.dat padasuthra.dat root.dat  revised_preferred_morph.dat parserid_wordid_mapping.dat  lwg_info.dat relations.dat hindi_meanings.dat GNP_agmt_info.dat id_Apertium_output.dat  hindi_id_reorder.dat English_sentence.dat hindi_sentence.dat >>$MYPATH/$1_tmp/$2/all_facts
...
#cat pada_debug.dat
#cat sd_relations_debug.dat
#cat sd-relations_tmp.dat
