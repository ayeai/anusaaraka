...
( echo "Running arabic [arabicFactored on Mona split of ATBp3v3 Bies-det utf8] on $host" ; java -server -mx3g edu.stanford.nlp.parser.lexparser.LexicalizedParser -evals "tsv,factDA" -v -maxLength 40 -tLPP edu.stanford.nlp.parser.lexparser.ArabicTreebankParserParams -arabicFactored -markStrictBaseNP -gpEquivalencePrepositionsVar -saveToSerializedFile arabicFactored.ser.gz -train $atbNewPlace/train3-final-bies-det.txt -test $atbNewPlace/dev3-final-bies-det.txt ) >>& ./serializedParsers.log

# Raw treebank buckwalter with decimation split like the Penn/LDC people use.
# Gets 80.06 in v1.6.1
( echo "Running arabic [arabicFactored ATBp3v3 decimation Bies-det buck] on $host" ; java -server -mx3g edu.stanford.nlp.parser.lexparser.LexicalizedParser -evals "tsv,factDA" -v -maxLength 40 -tLPP edu.stanford.nlp.parser.lexparser.ArabicTreebankParserParams -arabicFactored  -markStrictBaseNP -gpEquivalencePrepositionsVar -saveToSerializedFile atbP3FactoredBuckwalter.ser.gz -train $atbNewPlace/ATBp3-train.txt -test $atbNewPlace/ATBp3-dev.txt ) >>& ./serializedParsers.log
